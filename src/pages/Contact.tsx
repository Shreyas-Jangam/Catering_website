        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground px-4">
              Have an upcoming event? We'd love to serve you. Reach out for a customized quote.
            </p>
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-card rounded-xl shadow-soft">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-semibold text-foreground text-sm sm:text-base">Working Hours</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">Mon - Sun: 9:00 AM - 9:00 PM</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="bg-card p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-card">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Name *</label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div>
                      <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Location</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Number of Guests</label>
                      <input
                        type="number"
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Message</label>
                    <textarea
                      rows={4}
